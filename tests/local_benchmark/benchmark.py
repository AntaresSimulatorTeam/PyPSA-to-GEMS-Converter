...
@pytest.mark.parametrize(
    ...
    [
        ...
        #("france_clusters_80_snapshots_8760_period_one_week.nc", 0.8, "benchmark_study_france_clusters_80_snapshots_8760_period_one_week"),
    ],
)
def test_start_benchmark(file_name: str, load_scaling: float, study_name: str) -> None:
    ...
    logger.info(f"Converting PyPSA network to GEMS study")
    PyPSAStudyConverter(
    ...
    logger.info(f"Running Antares modeler")
    ...
    logger.info(f"Building PyPSA optimization problem")
    ...
    logger.info(f"Solving PyPSA optimization problem")
